                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <h1 class="title2 pt-3">Lesson Notes</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-11 p-3">
                            ...
                            <select class="form-select" id="s" required id="s" onchange="selectSubjectLesson();">
                        ...
                        <div class="col-lg-6 col-11 p-3">
                            ...
                            <select class="form-select" required id="g" onchange="selectSubjectLesson();">
