                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <h1 class="title2 pt-3">Teacher Registration</h1>
                                </div>
                                <p id="msg"></p>
                            </div>
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-6 col-11 p-3">
                                    ...
                                    <input class="form-control" type="number" id="m" required />
                                </div>
                                <div class="col-12">
                                    <hr />
                                </div>
                            ...
                            <div class="col-12 mt-1">
                                <div class="row">
                                    <div class="offset-2 col-8  d-grid">
                                        <button class="btn btn-primary fw-bold" type="sumbit" onclick="teacherRegister()">Register</button>
                                    </div>
                                </div>
                            </div>
