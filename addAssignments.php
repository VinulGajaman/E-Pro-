...
?>
    ...
    <body>
        ...
        <div class="container-fluid justify-content-center vh-100">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <h1 class="title2 pt-3">Add Assignments</h1>
                                </div>
                                <?php
                            ...
                            <form action="addAssignmentProcess.php" method="POST" enctype="multipart/form-data">
                                <div class="row mt-2">
                                    ...
                                    <div class="col-lg-12 col-11 p-3">
                                        <label class="form-label fw-bold fs-5 text-dark">Assignment Name</label>
                                    ...
                                    <div class="col-lg-6 col-11 p-3">
                                        ...
                                        $date = $d->format("Y-m-d");
                                        ?>
                                        <label class="form-label fw-bold fs-5 text-dark">Start Date</i></label> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input class="form-control"  min="<?php echo $date; ?>" type="date" name="s" id="start" required>
                                    </div>
                                    <div class="col-lg-6 col-11 p-3">
                                        <label class="form-label fw-bold fs-5 text-dark">End Date</i></label> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input class="form-control" type="date" min="<?php echo $date; ?>" name="e" id="end" required>
                                    </div>
                                    <div class="col-12">
                                        <hr />
                                    </div>
                                    <div class="col-lg-6 col-11 p-3">
                                        <label class="form-label fw-bold fs-5 text-dark">Upload Assignment File (.pdf)</i></label> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="file" name="assignment" accept="application/pdf" required />
                                    </div>
                                    ...
                                    <div class="col-12 mt-1">
                                        <div class="row">
                                            <div class="offset-2 col-8  d-grid">
                                                <button class="btn btn-primary fw-bold" type="sumbit">Sumbit</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 text-center">
                                        <h1 class="title2 pt-3">Uploaded Assignments</h1>
                                    </div>
                                    <div class=" col-lg-12 col-11 mt-3 mb-3" style="overflow-x:auto;">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $note = Database::search("SELECT * FROM `assignment`;");
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $noteData["start_date"]; ?> </td>
                                                            <td><?php echo $noteData["end_date"]; ?> </td>
            ...
            <!-- <script>
                function endDate() {
                    var startDate = document.getElementById("s").value;
                    console.log(startDate);
                    document.getElementById("e").min = startDate;
                }
            </script> -->
