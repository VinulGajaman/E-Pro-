            ...
            <div class="row r1 g-0 mt-5 mb-4">
                ...
                <div class="col-lg-7 text-center mt-4">
                    ...
                    <div class="col-12 d-lg-block ms-lg-5 ms-md-5">
                            ...
                            <hr>
                            <h1 class="mt-1 animate__animated animate__fadeIn animate__infinite infinite title1" style="font-size: 5rem;">Officer Sign In</h1>
                        </div>
                    </div>
                    ...
                    <div class="row p-3 pb-3">
                        ...
                        if (isset($_COOKIE["offun"])) {
                            $u = $_COOKIE["offun"];
                        }

                        if (isset($_COOKIE["offpw"])) {
                            $p = $_COOKIE["offpw"];
                        }
                        ...
                        <div class="row">
                            <div class="col-10 mt-4 offset-1 col-lg-5 d-grid">
                                <button class="btn btn-primary" onclick="officerSignIn();">Sign In</button>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="officerVerify();">Verify</button>
                    </div>
                </div>
            </div>
        </div>
